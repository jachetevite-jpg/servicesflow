document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function loadDashboardData() {
    ...
    try {
      ...
      document.getElementById('stat-interventions').textContent = '0';
      const tableBody = document.getElementById('recent-interventions-body');
      if (tableBody) {
        tableBody.innerHTML = '<tr><td colspan="5" class="text-center text-muted">Aucune intervention enregistrée.</td></tr>';
      }
    }
